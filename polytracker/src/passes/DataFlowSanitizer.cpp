...
static cl::opt<bool> ClCombinePointerLabelsOnLoad(
    "pt-dfsan-combine-pointer-labels-on-load",
...
static cl::opt<bool> ClCombinePointerLabelsOnStore(
    "pt-dfsan-combine-pointer-labels-on-store",
    cl::desc("Combine the label of the pointer with the label of the data when "
             "storing in memory."),
    cl::Hidden, cl::init(false));

static cl::opt<bool> ClDebugNonzeroLabels(
    "pt-dfsan-debug-nonzero-labels",
...
static cl::opt<bool> ClTrackSelectControlFlow(
    "pt-dfsan-track-select-control-flow",
...
static cl::opt<int> ClInstrumentWithCallThreshold(
    "pt-dfsan-instrument-with-call-threshold",
...
static cl::opt<int> ClTrackOrigins("pt-dfsan-track-origins",
...
bool DFSanFunction::useCallbackLoadLabelAndOrigin(uint64_t Size,
  ...
  const Align Alignment = llvm::assumeAligned(InstAlignment.value());
  if (Alignment >= MinOriginAlignment && Size % (64 / DFS.ShadowWidthBits) == 0)
    return false;
